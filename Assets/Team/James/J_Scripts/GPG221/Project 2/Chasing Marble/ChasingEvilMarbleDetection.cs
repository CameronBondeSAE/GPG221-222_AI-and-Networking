...
public class ChasingEvilMarbleDetection : MonoBehaviour
{
    public float detectionRange = 5f;
    public LayerMask detectionLayer;
    public Transform playerTransform;
    ChasingEvilMarbleSensor ChasingEvilMarbleSensor;
    public bool isPlayerNear;
    public bool isPlayerDetected;

    void Start()
    {
        ChasingEvilMarbleSensor = GetComponent<ChasingEvilMarbleSensor>();
    }
        ...
        foreach (var hitCollider in hitColliders)
        {
            ...
            if (Physics.Raycast(transform.position, directionToMarble, out RaycastHit hit, detectionRange))
            {
                ...
                if (hit.collider == hitCollider)
                {
                    ...
                    ChasingEvilMarbleSensor.SeesPlayer = true;
                    ChasingEvilMarbleSensor.IsHome = false;
    ...
    {
        ChasingEvilMarbleSensor.SeesPlayer = false;
        ChasingEvilMarbleSensor.IsChasing = false;
